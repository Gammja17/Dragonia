...
export const CHRONICLE = [
    ...
    {
        id: 'ev_falls', title: '발견 — 구름 폭포',
        when: c => c.map === 'FALLS',
        lines: [
            { who: '나', text: "(물소리가 말소리를 삼킨다. 벼랑 하나를 통째로 덮은 물이 쏟아져 내리고 있었다.)" },
            { who: 'Seiran', text: "…멈춰. 거기서 더 오면 젖어." },
            { who: 'Seiran', text: "아래에서 올라온 용이구나. 백 년 만인가. 나는 세이란. 이 물에 비친 것을 읽어." },
            { who: 'Seiran', text: "폭포 위에는 마을이 있어. 구름마루라고 해. 우리는 날개보다 물을 타고, 떨어지는 걸 두려워하지 않지." },
            { who: '나', text: "(올라가도 되느냐고 물으려다 그만두었다. 그 눈이 이미 안 된다고 말하고 있었다.)" },
    ...
    {
        id: 'ev_gathering', title: '모임 — 달이 가장 밝은 밤',
        when: c => c.map === 'FALLS' && c.gathering,
        lines: [
            { who: '나', text: "(폭포 아래에 불이 여럿 피어 있었다. 아래 마을 용들과, 처음 보는 긴 몸의 용들이 같은 불을 쬐고 있다.)" },
            { who: 'Kairon', text: "…왔구나. 이 자리에서는 아무도 싸우지 않는다. 그게 유일한 규칙이다." },
            { who: 'Riun', text: "저 아이인가. 하늘에서 떨어졌다는." },
            { who: 'Elder', text: "그렇소. 우리가 거두어 길렀소이다." },
            { who: 'Riun', text: "…백 년 전 우리가 서로에게 등을 돌린 뒤로, 두 마을에서 새로 난 아이는 서로를 본 적이 없지." },
    ...
    },
    {
        ...
        lines: [
            { who: '나', text: "(폭포 위에는 물이 고여 마을을 이루고 있었다. 집들이 물가를 따라 둥글게 앉아 있다.)" },
