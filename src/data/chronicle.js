...
export const CHRONICLE = [
    ...
    // 하던 게임을 이어서 켠 용에게는 둥지가 감쪽같이 사라진 것처럼 보인다. 한 번 일러 준다.
    {
        ...
        when: c => c.map === 'DEN' && c.s.den && c.s.den.built,
        lines: [
            { who: '나', text: "(공터 한복판에 있던 둥지가 없다. 대신 그 자리에 굴 입구가 뚫려 있었다.)" },
            { who: 'Elder', text: "(전에 엘더가 해 준 이야기가 떠올랐다.) 다 자란 용은 바깥에서 자지 않는단다." },
            { who: 'Elder', text: "둥지는 굴 안으로 들여놓았다. 알도, 품던 것도 그대로 있으니 걱정 말거라." },
