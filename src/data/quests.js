...
export const QUESTS = [
    // ---- 본 이야기: 촌장 엘더 ----
    {
        id: 'm1', needs: s => s.tutorial.toured, giver: 'Elder', act: 'main', title: '첫 사냥',
        ...
        done: "셋 다 잡았느냐. 해츨링치고 불꽃이 맵구나. 이건 수고비다.",
    ...
    },
    {
        ...
        done: "날개가 넓어졌구나. 이제 숲 깊은 데도 다닐 만하겠다.",
    ...
    },
    {
        ...
        done: "마을이 네 덕에 한숨 돌렸다. 이제 해 줄 얘기가 있다.",
    ...
    },
    {
        ...
        done: "모르가스가 드디어 쉬는구나. 네 안에서 냉기가 느껴진다. 숨결을 바꿔 써 봐라.",
    ...
    },
    {
        ...
        done: "번개까지 다루게 됐구나. 세 숨결을 다 가진 용은 내 평생 처음 본다.",
    ...
    },
    {
        ...
        done: "글라시아까지. 네 비늘에 서리가 앉았구나. 그 눈물은 기술을 더 빨리 되돌려 준다.",
    ...
    },
    {
        ...
        done: "바실까지 잡았느냐. 그론이 들으면 밤새 술을 마시겠구나. 이제 남은 건 하나다.",
    ...
    },
    {
        ...
        done: "해냈구나. 하늘이 파랗다. 이렇게 파란 게 몇 년 만인지 모르겠다. 이제 좀 쉬어라.",
    ...
    // ---- 티아맷의 이야기 ----
    {
        ...
        done: "하! 진짜 해냈네. 인정. 여섯 마리면 나도 반나절 걸려.",
    ...
    },
    {
        ...
        done: "세 번이나 막았네. 망루에서 보고 있었어. 이제 내가 자도 되겠다.",
    ...
    },
    {
        ...
        done: "이제 좀 용다워졌군. 단골 선물이다. 딴 데 가서 말하지 마라.",
    ...
    },
    {
        ...
        done: "다 찾았냐? 눈이 좋군. 상자는 아직 많이 남았을 거다.",
    ...
    },
    {
        ...
        done: "세 층이나? 안 무서웠어? 아니다, 대답하지 마. 다음엔 나도 갈게. 같이.",
        goal: { type: 'delve', count: 3 }, reward: { xp: 600, gold: 120, relation: 25 },
    },

    // ---- 스승 카이론의 이야기 ----
    {
        id: 'k1', giver: 'Kairon', act: 'Kairon', needs: s => s.story.lessons.length >= 1, title: '기초 체력',
        ...
        done: "땀 냄새가 나는군. 좋다. 씻고 와라.",
        goal: { type: 'killAny', count: 12 }, reward: { xp: 180, gold: 40 },
    },
    {
        id: 'k2', giver: 'Kairon', act: 'Kairon', needs: s => s.story.lessons.length >= 2, requires: 'k1', title: '금빛 사냥감',
        ...
        done: "정예를 잡았다고? 제법이군. 놈들이 가끔 [유물]을 떨어뜨리니 잘 봐라.",
        goal: { type: 'elite', count: 1 }, reward: { xp: 320, gold: 80 },
    },
    {
        id: 'k3', giver: 'Kairon', act: 'Kairon', needs: s => s.story.lessons.length >= 3, requires: 'k2', title: '스승의 밥상',
        ...
        done: "오오, 이 냄새. 크흠. 맛이 없진 않군. 너도 한 점 해라.",
        goal: { type: 'collect', count: 5 }, reward: { xp: 250, relation: 25 },
    },
    {
        id: 'k4', giver: 'Kairon', act: 'Kairon', needs: s => s.story.lessons.length >= 4, requires: 'k3', title: '형의 발자취',
        ...
        done: "다녀왔느냐. 그 열기가 내 형 이그나르의 숨결이다. 언젠가 네가 맞설 불이다.",
