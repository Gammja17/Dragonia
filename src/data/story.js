...
export const LESSONS = [
    { id: 'L1', level: 1,  title: '첫 수련: 꼬리 쓰는 법',   skill: 'TAIL_SWIPE',   drill: { type: 'TARGETS', count: 4, hp: 40, time: 45 },
      intro: "숨결만 믿다가 죽은 용을 여럿 봤다. 몸을 써라. 저 허수아비 넷, 꼬리로 부숴라." },
    { id: 'L2', level: 2,  title: '둘째 수련: 피하는 법',     skill: 'ROAR',         drill: { type: 'DODGE', time: 20, rate: 0.55 },
      intro: "안 맞는 게 제일 좋은 방어다. 내 불씨를 스무 숨 동안 피해 봐라. 굴러도 되고 뛰어도 된다." },
...
export const PROLOGUE = {
    ...
    // 포코가 데려온 엘더가 알아본다
    elder: [
        { who: 'Elder', text: '포코야, 이 밤중에 무슨 소란이…' },
        { who: 'Elder', text: '……' },
        { who: 'Elder', text: '(엘더는 한참 말이 없었다.)' },
        { who: 'Elder', text: '별이 아니다, 포코야. 용이다.' },
        { who: 'Elder', text: '삼백 년 만이구나. 하늘에서 내려온 건.' },
        { who: 'Elder', text: '그론을 깨워라. 들것이 필요하다. …뛰어.' },
    ],
};
...
export const SCENES = [
    {
        ...
        lines: [
            { who: '???', text: "(떨어지는 꿈을 꿨다. 등 뒤에서 불타는 날개가 웃고 있었다.)" },
            { who: 'Elder', text: "일어났느냐. 밤새 끙끙대더구나. 떨어지던 날 꿈이겠지." },
            { who: 'Elder', text: "그론이 고기를 굽고, 포코가 밤새 옆에서 떠들었다. 둘 다 잠을 못 잤을 게다." },
            { who: 'Elder', text: "오늘 할 얘기가 있다고 했지. 밖에 나와 봐라." },
            { who: 'Elder', text: "너를 가르칠 용을 불렀다. [카이론]. 젊을 땐 이 숲에서 제일 셌고, 지금은 제일 잔소리가 많다." },
            { who: 'Kairon', text: "이 꼬맹이가 그 녀석이오? 눈은 쓸 만하군." },
            { who: 'Kairon', text: "동쪽 길 따라 숲을 지나면 내 수련장이다. 거기로 와라. 늦지 말고." },
            { who: 'Kairon', text: "하루에 하나씩 가르친다. 끝나면 자라. 용은 자면서 큰다." },
        ],
    },
    {
        id: 'ch1b', title: '1장. 같이 구르는 사이', when: s => s.story.lessons.length >= 1,
        lines: [
            { who: '나', text: "(어깨가 뻐근하다. 어제 허수아비를 그렇게 쳤으니.)" },
            { who: 'Nara', text: "일어났어? 나 벌써 한 바퀴 돌고 왔는데." },
            { who: 'Nara', text: "거짓말이야. 나도 방금 일어났어. 어깨 아파 죽겠어." },
            { who: 'Nara', text: "스승님이 그러셨어. 아픈 건 크는 거래. 그 말 믿고 오늘도 간다." },
            { who: '나', text: "(떨어진 날엔 이런 아침이 올 줄 몰랐다.)" },
        ],
    },
    {
        id: 'ch2', title: '2장. 자라는 날개', when: s => s.story.lessons.length >= 2,
        lines: [
            { who: 'Kairon', text: "제법 따라온다. 근데 몸이 작아서 숨결에 힘이 안 실린다." },
            { who: 'Kairon', text: "레벨이 차면 [승급 시험]을 청해라. 나를 이기면 몸이 한 뼘 큰다." },
            { who: 'Nara', text: "나는 지난달에 한 번 졌어. 다음엔 꼭 이길 거야. 너보다 먼저." },
            { who: '나', text: "(스승님을 이겨야 큰다니. 밥부터 많이 먹어 둬야겠다.)" },
        ],
    },
    {
    ...
    },
    {
        ...
        lines: [
            ...
            { who: 'Elder', text: "어디서 만들어졌든 여기서 자랐다. 오늘부터 네가 이 마을의 수호룡이다. 나는 이제 좀 쉬마." },
            { who: 'Nara', text: "숫자 다시 셀 거야. 오늘부터 0부터. 같이." },
            { who: 'Poco', text: "수호룡님! 그래도 나랑 술래잡기는 계속 해 줄 거지?!" },
            { who: '나', text: "(이그나르는 나를 만들었다. 마을은 나를 길렀다. 둘 중 하나를 고르라면 답은 벌써 나와 있다.)" },
