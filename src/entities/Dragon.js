...
export class Dragon extends Entity {
    ...
    draw(ctx) {
        ...
        if (this.fishing) {
            ...
            if (f.bite > 0) {
                ctx.font = '900 30px "KOTRA LEAP", sans-serif'; ctx.textAlign = 'center';
    ...
    drawNameplate(ctx) {
        ...
        ctx.font = '600 13px "Bookk Myungjo", serif';
        ...
        if (mark) {
            ctx.font = '900 30px "KOTRA LEAP", sans-serif';
        ...
        if (this.chatFade > 0 && this.currentChat) {
            ...
            ctx.font = '13px "Bookk Myungjo", serif';
