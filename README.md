...
src/
  ...
  systems/          combat, raid, kids, dialogue, status, quests(퀘스트·추적),
                    ...
                    cutscene(사건 연출), routine(일과대로 용 옮기기), guide(퀘스트 길잡이·자동 이동),
...
- **Space** 말 걸기. 상대가 없으면 눈앞의 것(상자 · 열매 · 석비 · 굴 · 둥지)을 쓴다. 따라오는 짝보다 눈앞의 물건이 먼저다
- **E** 말은 걸지 않고 눈앞의 것만. 상자 · 열매 · 줍기 · 낚시 · 석비 · 굴 · 게시판 · **T** 곁의 용에게 말 걸기
- **길잡이** 오른쪽 추적창을 누르면 목표까지 알아서 걸어간다 (방향키를 누르면 멈춘다). 금빛 화살표가 목표를, 화면 밖이면 가장자리 화살표가 방향을 가리킨다 (`systems/guide.js`)
- **방향키** 대화 선택지 고르기 (**Space** 로 결정)
- **C** 고기 먹기 (상호작용과 섞이면 상자를 열려다 고기가 먹힌다)
- **Z** 날아오르기 · 내려앉기 (성체부터) · **P** 가족 · **U** 좌우 UI 접기 · **J** 일지 (퀘스트 · 지도 · 소지품 · 마을 용들 · 기록 · 유물 · 도감) · **M** 세계 지도 · **I** 소지품
- **마우스 휠** 시점 확대·축소 (**V** 로도 단계를 넘긴다) · **O** 소리 끄기 · **Esc** 설정(소리 슬라이더) · 창 닫기
